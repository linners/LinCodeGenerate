...
public class HttpClientUtil {
	 ...
	 * post 请求
	 * @param url
	 * @param encoderJson  json格式的字符串
	 * @return
	 */
	public static String post(String url, String encoderJson) {
		HttpPost httppost = new HttpPost(url);
		CloseableHttpResponse response = null;
		String responseString = null;
		try {
			StringEntity s = new StringEntity(encoderJson, ContentType.APPLICATION_JSON);
			...
			log.error("post :" + url + ",para:" + encoderJson, e);
